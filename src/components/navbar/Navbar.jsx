...
const features = [
  ...
  },
  {
    name: "About",
    href: "/about",
    description: "Find out why you need to use ReddeOnline Payment Platform!",
...
const resources = [
  ...
  },
  {
    ...
    description: "/about/our-strategy",
    target: "_blank",
    icon: BookmarkAltIcon,
  },
  {
...
function Navbar() {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <nav
        className={
          scrolled ? "bg-white shadow-md shadow-slate-200" : "bg-white"
        }
      >
                ...
                <Link
                  className={
                    scrolled
                      ...
                      : "text-base font-medium text-gray-900 hover:text-yellow-500"
                  }
                  href="/"
                >
                  Home
                        ...
                        <Popover.Button
                          className={classNames(
                            open
                              ...
                              : scrolled
                              ? "text-base font-medium text-yellow-500 hover:text-gray-900 group inline-flex items-center "
                              : "text-base font-medium text-gray-900 hover:text-yellow-500 group inline-flex items-center"
                          )}
                        >
                          <span>About</span>
                          {open ? (
