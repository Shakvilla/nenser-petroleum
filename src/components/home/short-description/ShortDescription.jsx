...
const ShortDescription = () => {
  return (
    <div className=" flex flex-col lg:flex-row container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          ...
          <div className="lg:flex gap-x-8">
            <div className="flex flex-col">
              ...
              <Text>
                Our target is simple, exceptional service to our customers that
                exceeds their expectations while building lasting relationships
                and trustworthiness even as we ensure that our people uphold the
                highest regulatory, health, safety, environmental and quality
                standards applicable anywhere in the world.
              </Text>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <Text>
                Specifically, we will provide the oil marketing companies (OMCs)
                with high quality petroleum products to market to industrial
                entities and the public. NENSER will also supply bulk consumers
                and will offer highly efficient and environmental safe petroleum
                products tank farm services to its clients in the downstream
